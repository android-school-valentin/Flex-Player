package ru.valentine.flexplayer.core.media
...
private constructor(
    ...
    companion object Builder {
        ...
        /**
         * Media of this type are vk-defined list.
         * A collection of playlists and tracks.
         *
         * @see MediaId.type
         */
         ...
         */
        @JvmField
        val ALL_TRACKS = fromParts(TYPE_TRACKS, CATEGORY_ALL)

        /**
         * The unique identifier of the parent of all albums.
         */
        @JvmField
        val ALL_ALBUMS = fromParts(TYPE_ALBUMS)

        /**
         * The unique identifier of the parent of all saved.
         */
        @JvmField
        val ALL_SAVED = fromParts(TYPE_SAVED)

        /**
         * The unique identifier of the parent of all recommendations.
         */
        @JvmField
        val ALL_RECOMMENDATIONS = fromParts(TYPE_RECOMMENDATIONS)
